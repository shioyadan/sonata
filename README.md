...
再生と1サイクル送りは区間の境界を越えて続きます。次の区間を先読みし、読込みに追いついた場合は続きを待ち、ファイル末尾で停止します。速度は0.25〜32×から選べます。全体側の **Start / Latest** は先頭／読込済み末尾の区間へ移動します。**Go to cycle** にはサイクル番号、表示幅、スレッド、履歴の **Back / Forward**、**Bookmark**、明示的な **Loop window** をまとめています。同梱デモは従来どおり末尾でループします。
